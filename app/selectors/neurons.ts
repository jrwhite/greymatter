...
import neurons from '../reducers/neurons';
...
export const getNeuron = (state: IState, id: string) =>
  state.network.neurons.byId[id]!!;

export const getNeuronPos = (state: IState, id: string): Point =>
  getNeuron(state, id).pos;

export const getDend = (neuron: NeuronState, id: string) =>
  neuron.dends.byId[id]!!;
...
//   state.network.neurons.byId[props.id]!!
